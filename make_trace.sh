...
do
    ...
    # pin -t /home/lixiang/mem-pattern-recognition/tracer/obj-intel64/mpr_tracer.so -- ./run.sh /home/lixiang/mem-pattern-recognition/trace/${app}.trace
    ...
    cd /mnt/centos00-home/lixiang/trace/
    xz ${app}.trace -f
done
